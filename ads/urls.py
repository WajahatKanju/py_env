...
from .views import AdListView, AdCreateView, AdUpdateView, AdDeleteView, AdDetailView, stream_file, CommentCreateView, CommentDeleteView, AddFavoriteView, DeleteFavoriteView
...
urlpatterns = [
    ...
    path('ad/<int:pk>/comment', CommentCreateView.as_view(),
        name='ad_comment_create'),
    path('comment/<int:pk>/delete',
        CommentDeleteView.as_view(), name='ad_comment_delete'),
